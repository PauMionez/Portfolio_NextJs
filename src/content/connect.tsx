  ...
  return (
    <div className="bento-card p-4 col-span-1 md:col-span-2 space-y-3 group animate-fade-in animation-delay-500">
      ...
      <div className="space-y-4">
        <a
          className="block p-2 rounded-md bg-black hover:bg-gray-800 transition-colors"
        ...
        <div className="block p-2 rounded-md bg-black transition-colors">
          <p className="text-xs text-foreground/70">Phone</p>
          <p className="text-sm font-medium">09365318575</p>
        </div>
        <a
          className="flex items-center gap-2 p-2 rounded-md bg-black hover:bg-gray-800 transition-colors"
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <a
              ...
              className="flex items-center justify-center p-2 rounded-md bg-black hover:bg-gray-800 transition-colors"
